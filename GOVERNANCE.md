# Cloud Native Compositions Project Governance

[Instructions](https://contribute.cncf.io/maintainers/github/templates/required/governance-maintainer/)

<!-- template begins here-->

The Cloud Native Compositions project is dedicated to creating [TODO:Goals of project].  
...
The Cloud Native Compositions project and its leadership embrace the following values:
...
Cloud Native Compositions Maintainers have write access to the [project GitHub repository](TODO).
...
are people who care about the Cloud Native Compositions project and want to help it grow and
...
While most business in Cloud Native Compositions is conducted by "[lazy consensus](https://community.apache.org/committers/lazyConsensus.html)", 
